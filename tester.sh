...
gcc ex02.c
echo -e "${GREEN}"
./a.out <<< "-1"  && echo -e "${DEFAULT} --> fatorial de -1 == NaN${GREEN}"
...
./a.out <<< "11"  && echo -e "${DEFAULT} --> fatorial de 11 == 39916800${GREEN}"
./a.out <<< "12"  && echo -e "${DEFAULT} --> fatorial de 12 == 479001600${GREEN}"
./a.out <<< "13"  && echo -e "${DEFAULT} --> fatorial de 13 == 6227020800 (above int range)${GREEN}"
echo -e "${DEFAULT}"
